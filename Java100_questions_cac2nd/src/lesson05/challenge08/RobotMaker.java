...
class Robot {
	...
	String makeEggDishes(int flour, int sugger, int egg, int butter) {

		String menu = null;
		if (flour >= 170 && sugger >= 50 && egg >= 1 && butter >= 80) {
			menu = "クッキー";
...
public class RobotMaker {
	...
	public static void main(String[] args) throws IOException {
		...
		String menu = robot.makeEggDishes(flourNum, sugarNum, eggNum, butterNum);//ここでRobotクラスのインスタンスを作り、
		if (menu != null) {
